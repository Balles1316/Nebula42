...
function draw() {
    ...
    ctx.fillStyle = "#fff";
    ctx.font = "18px Arial";
    ctx.fillText(`Gemas: ${orbesRecolectadas} / ${ORBES_NECESARIAS}`, 30, 36);
    ...
    if (!juegoIniciado) {
        ...
        ctx.font = "32px Arial";
        ctx.fillText("Level 5: Humanity Reborn", W / 2, H / 2 - 40);
        ctx.font = "18px Arial";
        ctx.fillText("Mission: Collect 5 gems of harmony to complete planetary restoration and bring humanity back.", W / 2, H / 2 - 10);
...
const infoText = "With near real-time satellite data, NASA helps communities assess flood risks and respond effectively to disasters.";
