...
imgBackground.src = "../resources/fondonivel4.jpg";

const imgPlayer = new Image();
imgPlayer.src = "../resources/astronaut.png";

const imgCoin = new Image();
imgCoin.src = "../resources/huevoo.png";
...
const infoText = "NASA satellites monitor soil moisture and vegetation health to support sustainable farming practices worldwide.";
