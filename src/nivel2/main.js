...
imgCoin.src = "../resources/gotas.png";
    ...
    for (let orb of orbList) {
        ...
        if (dist < 30) {
            ...
            if (orbesRecolectadas == ORBES_NECESARIAS) {
                window.open("../nivel3/index.html", "_self");
            }
        }
    }
...
function draw() {
    ...
    if (!juegoIniciado) {
        ...
        ctx.font = "32px Arial";
        ctx.fillText("Level 2: The Blue Awakening", W / 2, H / 2 - 40);
        ctx.font = "18px Arial";
        ctx.fillText("Mission: Collect 5 water drops to restore moisture and fill the first lakes.", W / 2, H / 2 - 10);
